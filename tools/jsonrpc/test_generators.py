...
The error taxonomy parser is exercised against the real JSONRPCUtils.h so
that a reshape of the header fails loudly here rather than silently
...
class TestExamples(unittest.TestCase):
    ...
    def test_examples_exist(self):
        self.assertEqual(len(self.examples), 7)
