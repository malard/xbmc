...
#
"""Turning values and prose into the HTML fragments the documentation site is built from.

Kept apart from the site generator because none of it knows anything about the site: it
escapes, it renders a JSON value as a block, and it converts the small Markdown subset the
prose documents use. The subset is deliberately small - it covers what CHANGELOG.md and
MIGRATING-v13-to-v14.md actually contain, and nothing else.
"""
