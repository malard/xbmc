...
#
"""Rendering a JSON Schema fragment as the HTML the reference pages are made of.

Separate from the site generator because it decides how a schema reads, not which
pages exist: the inline phrase a type column shows, the table a set of properties
becomes, and the plain-text placeholder that stands for a value in an envelope
skeleton. The only thing it knows about the site is the version directory type
links point into.
"""
...
class SchemaRenderer:
    """Renders schema fragments; `vdir` is the major-version directory type links point into."""
